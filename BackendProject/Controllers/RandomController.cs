...
namespace BackendProject.Controllers
{
    ...
    public class RandomController : ControllerBase
    {
        ...
        public ActionResult<Dictionary<string, int>> Get()
        {
            ...
            result.Add("Scopped 1", _randomServiceScoped.Value);
            result.Add("Transint 1", _randomServiceTransient.Value);

            result.Add("Singleton 2", _randomService2Singleton.Value);
            result.Add("Scopped 2", _randomService2Scoped.Value);
            result.Add("Transint 2", _randomService2Transient.Value);
